 ...
 */
	...
	UI_DrawString( 320, 414, "Mix3r_Durachok & Company. Voice by Alex Style.", UI_CENTER|UI_SMALLFONT, color );
...
void UI_MainMenu( void )
{
	...
	s_main.singleplayer.generic.callback	= Main_MenuEvent;
        s_main.singleplayer.string                      = COM_Localize(1);
	...
	s_main.multiplayer.string				= COM_Localize(2);
