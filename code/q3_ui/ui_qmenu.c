	...
	//} else {
                if (Q_strequal(cl_language.string, "ru")) {
                        if (ui_is_missionpack) {
                                uis.menuBackShader = trap_R_RegisterShaderNoMip( "textures/sfx/logo512_tatribute_ru" );
                        } else if (trap_R_RegisterShaderNoMip("levelshots/Q3DM0.jpg")) {
                                uis.menuBackShader = trap_R_RegisterShaderNoMip( "textures/sfx/logo512_qtribute_ru" );
                        } else {
                                uis.menuBackShader = trap_R_RegisterShaderNoMip( "textures/sfx/logo512_ru" );
                        }
                } else {
		        if (ui_is_missionpack) {
                                uis.menuBackShader = trap_R_RegisterShaderNoMip( "textures/sfx/logo512_tatribute" );
                        } else if (trap_R_RegisterShaderNoMip("levelshots/Q3DM0.jpg")) {
                                uis.menuBackShader = trap_R_RegisterShaderNoMip( "textures/sfx/logo512_qtribute" );
                        } else {
